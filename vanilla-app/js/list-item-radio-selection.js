...
document.querySelector('#app').innerHTML = `
    ...
    <pie-radio-group id="delivery-leading" name="deliveryLeading" value="express" variant="list">
        ...
        <pie-list-item primaryText="Standard" secondaryText="3 to 5 days" metaText="Free">
            <pie-radio slot="leading" value="standard"></pie-radio>
        </pie-list-item>
        <pie-list-item primaryText="Express" secondaryText="Next day" metaText="£2.99">
            <pie-radio slot="leading" value="express"></pie-radio>
        </pie-list-item>
        <pie-list-item disabled primaryText="Collection" secondaryText="Pick up in store">
            <pie-radio slot="leading" value="collection" disabled></pie-radio>
        </pie-list-item>
        <pie-list-item primaryText="Locker" secondaryText="Collect at your convenience" metaText="Free">
    ...
    <pie-radio-group id="delivery-trailing" name="deliveryTrailing" value="locker" variant="list">
        ...
        <pie-list-item primaryText="Standard" secondaryText="3 to 5 days">
            <pie-radio slot="trailing" value="standard"></pie-radio>
        </pie-list-item>
        <pie-list-item primaryText="Express" secondaryText="Next day">
            <pie-radio slot="trailing" value="express"></pie-radio>
        </pie-list-item>
        <pie-list-item disabled primaryText="Collection" secondaryText="Pick up in store">
            <pie-radio slot="trailing" value="collection" disabled></pie-radio>
        </pie-list-item>
        <pie-list-item primaryText="Locker" secondaryText="Collect at your convenience">
