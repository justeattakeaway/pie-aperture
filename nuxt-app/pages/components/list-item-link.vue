<template>
    <div>
        ...
        <pie-list aria-label="Manage your restaurant (anchor)">
            ...
            <pie-list-item hasDivider interactionType="link" primaryText="Menu" secondaryText="Edit items, prices and photos">
                <a slot="link" href="#menu"></a>
            </pie-list-item>
            <pie-list-item hasDivider interactionType="link" primaryText="Opening hours" secondaryText="Set your weekly schedule">
        ...
        <h2 id="link-nuxtlink-heading" style="padding: 8px 0;">Link rows (NuxtLink component)</h2>
        <pie-list aria-label="Manage your restaurant (NuxtLink)">
            <pie-list-item hasDivider interactionType="link" primaryText="Orders" secondaryText="View and manage live orders" metaText="12 active">
                <NuxtLink slot="link" to="#orders" />
            </pie-list-item>
            <pie-list-item hasDivider interactionType="link" primaryText="Menu" secondaryText="Edit items, prices and photos">
                <NuxtLink slot="link" to="#menu" />
            </pie-list-item>
            <pie-list-item hasDivider interactionType="link" primaryText="Opening hours" secondaryText="Set your weekly schedule">
                <NuxtLink slot="link" to="#opening-hours" />
            </pie-list-item>
            <pie-list-item interactionType="link" primaryText="Payouts" secondaryText="Invoices and bank details" metaText="Weekly">
                <NuxtLink slot="link" to="#payouts" />
            </pie-list-item>
        </pie-list>
    </div>
</template>
...
// `NuxtLink` renders an `<a>` and forwards the `slot` attribute, so it works as the stretched target.
definePageMeta({
