<template>
    <div class="tooltip-showcase">
        ...
        <section class="tooltip-default">
            ...
            <pie-tooltip trigger="default-tooltip-trigger" :isOpen="true">
        ...
        <section>
            ...
            <pie-button id="dismissible-tooltip-trigger" @click="isDismissibleOpen = true">Delivery times</pie-button>
            <pie-tooltip
                ...
                :aria="{ close: 'Close' }"
                @pie-tooltip-close="isDismissibleOpen = false">
        ...
        <section>
            ...
            <pie-tooltip trigger="action-tooltip-trigger" :isOpen="true" heading="Delivery times">
                <span slot="content">Orders placed before 6pm arrive today.</span>
        ...
        <section class="tooltip-sizing-variants">
            ...
            <pie-tooltip trigger="fit-tooltip-trigger" :isOpen="true" size="fit-to-content">
                <span slot="content">Arrives today.</span>
            </pie-tooltip>
            <div style="margin-top: var(--dt-spacing-j);">
                ...
                <pie-tooltip trigger="fill-tooltip-trigger" :isOpen="true" size="fill-container">
            ...
            <div class="tooltip-inverse">
                ...
                <pie-tooltip trigger="inverse-tooltip-trigger" :isOpen="true" variant="inverse">
                    <span slot="content">Arrives today.</span>
                </pie-tooltip>
            </div>
            <div style="margin-top: var(--dt-spacing-j);">
                <pie-icon-button id="icon-tooltip-trigger" :aria="{ label: 'Delivery times' }">
                    <icon-info-circle></icon-info-circle>
                </pie-icon-button>
                <pie-tooltip trigger="icon-tooltip-trigger" :isOpen="true" type="icon">
                    <span slot="content">Arrives today.</span>
                </pie-tooltip>
            </div>
        </section>
        ...
        <section>
            ...
            <div class="tooltip-positions">
                <div v-for="position in positions" :key="position" :style="{ gridArea: position }">
                    <button :id="`tooltip-${position}`" class="tooltip-placement-anchor" type="button" :aria-label="position"></button>
                    <pie-tooltip :trigger="`tooltip-${position}`" :isOpen="true" :position="position" size="fit-to-content">
